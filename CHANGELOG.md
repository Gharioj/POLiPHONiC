...
- **Received** eight manuscript sections via chat, appended verbatim in order to the reception scaffold at `constitutional-staging/constitutional-drafts/working-draft-1.md`, each confirmed individually before the next was requested. Section boundaries and structural observations were recorded inline as repository comments (not constitutional text) as each section arrived.
- **Manuscript integrity pass**, performed once the manuscript was declared complete ("END OF MANUSCRIPT"): confirmed section order and Markdown validity; found and reported, without correcting, four categories of anomaly present in the manuscript as received — (1) article-numbering gaps: Articles 1–30 and 37–49 are entirely absent, and Section 2 opens with an unheaded, unnumbered fragment before Article 31; (2) three inconsistent top-level structural labelling schemes (unlabelled in Section 1; "Volume IV" + "Chapter 5" in Section 4; "Part I" + "Chapter 6" in Section 6) with no Volumes I–III, Chapters 1–4, or further Parts present; (3) two pairs of duplicate article titles with different body text ("Constitutional Coherence" — Articles 64 and 84; "Constitutional Proportionality" — Articles 51 and 85); (4) two article titles ("Constitutional Resolution," Article 55; "Constitutional Discovery," Article 73) that reuse names this repository already assigns a different, specific meaning to (`constitutional-resolutions/`, `constitutional-discoveries/`). The only correction made anywhere was to this repository's own bookkeeping metadata (a stale `sections_received` counter) — never to constitutional text.
- **Added** `constitution/` — a new top-level directory, distinct from `constitutional-staging/` and `constitutional-foundation/`, per the explicit architecture given with this integration: "The Foundation documents are the constitutional research and discovery record. Working Draft 1 becomes the first authoritative integrated constitutional draft." Contains `working-draft-1.md` (the verbatim manuscript, with the same inline structural-observation comments carried over from staging), `working-draft-1.provenance.md` (full receipt history, the integrity report above, and cross-references to Discoveries 001 and 003), and a `README.md` establishing the directory's role and the pattern a future Working Draft 2 will follow.
- **`constitutional-staging/constitutional-drafts/working-draft-1.md` and its provenance file** were replaced with short stubs pointing to the new `constitution/` location — the manuscript is not duplicated across two locations; the stub preserves the historical fact that this is where it was received and assembled.
- **`constitutional-foundation/README.md`** — added a "The Constitution" section and reframed the opening description: the Foundation is now documented as the constitutional research and discovery record, distinct from the operative draft. No Foundation document (39 `.md` files or their `.provenance.md` companions) was modified, moved, or deleted.
- **`constitutional-discoveries/001-rights-vs-ownership-undefined.md` and `003-undefined-governance-authority-and-process.md`** — each given a dated note on where Working Draft 1 speaks to the discovery (Article 36 for 001; Articles 59–62 and 66–72 for 003), following the same pattern used for the two working sessions staged earlier. Neither discovery's status changed from Open; nothing here resolves either.
- `constitutional-staging/README.md`, `constitutional-staging/constitutional-drafts/README.md`, `constitutional-discoveries/README.md` and root `README.md` (Status, Structure, Architecture diagram, Phase) — updated for the new directory and the completed integration.
- No constitutional judgement made: no constitutional text was authored, edited, or reconciled; no discovery was resolved; no Constitutional Resolution was created; the numbering gaps, label inconsistencies, and duplicate titles found in the manuscript were reported, not fixed. The decision to place the integrated draft in a new `constitution/` directory rather than inside `constitutional-foundation/` is a repository-engineering decision executing the architecture explicitly given with this instruction, not an independent constitutional judgement.

## 0.37.0 — 2026-07-20
Scaffolded the manuscript file itself for "POLiPHONiC Constitution — Working Draft 1," on the clarification that the manuscript "does not yet exist as a single constitutional manuscript" but "will be supplied separately by the constitutional architects." Per explicit instruction: file structure, metadata and provenance references only — no constitutional text written, invented, inferred or reconstructed, and no section outline guessed at.

- **Added** `constitutional-staging/constitutional-drafts/working-draft-1.md`: an empty placeholder manuscript with a title, version metadata (version, supersedes, status, date scaffolded) and a single "Pending" body section. Filename uses this repository's existing kebab-case convention (`working-draft-1.md`, matching the pattern already documented for this directory) rather than the literal spaced/em-dash string given in conversation; the exact requested title "POLiPHONiC Constitution — Working Draft 1" is preserved as the document's own H1 and front-matter `title` field. Deliberately contains no proposed table of contents or article/section outline — inventing one ahead of the manuscript would itself be a guess at its content.
- **Added** `constitutional-staging/constitutional-drafts/working-draft-1.provenance.md`: a provenance record scoped explicitly to the scaffold file, not to any constitutional content (there is none yet). Records the instruction trail, and flags without resolving an open question: whether the "multiple drafting sessions" referenced in the clarifying instruction include the drafting-session material already staged in `constitutional-staging/` (the two 2026-07-20 working sessions and the architecture/development observations) is not stated, and is not assumed here either way.
- `constitutional-staging/constitutional-drafts/README.md` — Index updated to show Working Draft 1 as **Scaffolded** (a new status distinct from *Staged* and *Reviewed/Integrated*, defined in a new "Status vocabulary" note); added a "Receiving the manuscript" section stating that the manuscript should be written into the existing placeholder file in place, so that no further renaming or restructuring of this directory should be needed once it arrives.
- `constitutional-staging/README.md` and root `README.md` — updated to point at the actual scaffold file rather than only the containing directory.
- No constitutional judgement made: no constitutional text exists in the new manuscript file, no existing document's wording changed, no discovery resolved, and no claim made about how Working Draft 1 will relate to the Foundation's 39-document structure or to the already-staged drafting-session fragments.
